...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    yield
    # Close the shared httpx client on shutdown — access via module reference
    # so we get the *current* value, not the None captured at import time.
    client = _schema_mod._client
